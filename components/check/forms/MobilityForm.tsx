  ...
  return (
    <FormWrapper title="이동 및 보행 상세 질문">
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="space-y-3">
            <FormLabel>현재 보행 능력은 어떠신가요?</FormLabel>
            <FormControl>
              <RadioGroup
              ...
              >
                <div className="flex items-center space-x-3 space-y-0">
                  ...
                  <Label htmlFor="mob-indep" className="font-normal">
                    독립 보행 가능
                  </Label>
                </div>
                <div className="flex items-center space-x-3 space-y-0">
                  <RadioGroupItem value="cane" id="mob-cane" />
                  <Label htmlFor="mob-cane" className="font-normal">
                    지팡이/목발 사용
                  </Label>
                </div>
                <div className="flex items-center space-x-3 space-y-0">
                  <RadioGroupItem value="walker" id="mob-walker" />
                  <Label htmlFor="mob-walker" className="font-normal">
                    워커(보행기) 사용
                  </Label>
                </div>
                <div className="flex items-center space-x-3 space-y-0">
                  <RadioGroupItem value="manual_wheelchair" id="mob-manual" />
                  <Label htmlFor="mob-manual" className="font-normal">
                    수동 휠체어 사용
                  </Label>
                </div>
                <div className="flex items-center space-x-3 space-y-0">
                  <RadioGroupItem value="power_wheelchair" id="mob-power" />
                  <Label htmlFor="mob-power" className="font-normal">
                    전동 휠체어 사용
                  </Label>
                </div>
                <div className="flex items-center space-x-3 space-y-0">
                  <RadioGroupItem value="bedridden" id="mob-bed" />
                  <Label htmlFor="mob-bed" className="font-normal">
                    침상 생활 (거동 불가)
                  </Label>
                </div>
              </RadioGroup>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="space-y-3">
            <FormLabel>상지(팔/손) 근력 상태는 어떠신가요?</FormLabel>
            <FormControl>
              <RadioGroup
                onValueChange={field.onChange}
                defaultValue={field.value}
              ...
              >
                <div className="flex items-center space-x-3 space-y-0">
                  ...
                  <Label htmlFor="arm-normal" className="font-normal">
                    정상 (양손 사용 자유로움)
                  </Label>
                </div>
                <div className="flex items-center space-x-3 space-y-0">
                  <RadioGroupItem value="weak" id="arm-weak" />
                  <Label htmlFor="arm-weak" className="font-normal">
                    근력 약화 (무거운 것 들기 힘듦)
                  </Label>
                </div>
                <div className="flex items-center space-x-3 space-y-0">
                  <RadioGroupItem value="paralysis" id="arm-paralysis" />
                  <Label htmlFor="arm-paralysis" className="font-normal">
